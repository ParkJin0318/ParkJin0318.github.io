...
class Parameters private constructor(val raw: String, val map: Map<String, List<String>>) {
    companion object {
        ...
        fun from(rawParameters: String): Parameters {
        ...
        fun from(parameters: Map<String, List<String>>): Parameters {
        ...
        fun from(parameters: Map<String, String>): Parameters {
        ...
        fun from(vararg parameters: Pair<String, String>): Parameters = from(parameters.toMap())

        fun from(vararg parameters: Pair<String, List<String>>): Parameters =
            from(parameters.toMap())
